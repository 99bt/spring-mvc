...
<head lang="zh-CN">
    ...
    <title>${platFormName! }-穿越火线</title>
    <link rel="stylesheet" href="${staticPath! }/static/lansha/cf_wap/static/css/jquery.xBox.min.css${staticVersion! }"/>
    <link rel="stylesheet" href="${staticPath! }/static/lansha/cf_wap/static/css/common.css${staticVersion! }" />
    <script>
        <#-- 登录状态 1已登录 0未登录 -->
...
<!--conent start-->
<div class="banner">
    <div class="banner-pic autoImg"><img src="${staticPath! }/static/lansha/cf_wap/static/images/cf_banner.jpg" alt=""/></div>
    <div class="user-box">
        <#if userIsLogin>
        ...
        <div class="lottery" id="lottery">
            <ul>
                <li class="lottery-unit lottery-unit-0">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_0.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-1">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_1.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-2">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_2.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-3">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_3.png" alt="">
                    <i></i>
                </li>

                <li class="lottery-unit lottery-unit-9">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_9.png" alt="">
                    <i></i>
                </li>
                ...
                <li class="lottery-unit lottery-unit-4">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_4.png" alt="">
                    <i></i>
                </li>

                <li class="lottery-unit lottery-unit-8">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_8.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-7">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_7.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-6">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_6.png" alt="">
                    <i></i>
                </li>
                <li class="lottery-unit lottery-unit-5">
                    <img src="${staticPath! }/static/lansha/cf_wap/upload/lottery_5.png" alt="">
                    <i></i>
                </li>
            </ul>
        </div>
    </div>
    <div class="awards mgt8">
        <h4 class="awards-title">获奖记录</h4>
        <ul class="awards-list" id="awards-list">
        	<li class="clearfix" id="awards_n1" style="display: none;"><span class="fl">获得1个Q币</span><a href="javascript:;" class="get fr">领取</a></li>
...
<div class="chance-explain" style="margin: 10px auto;">
    <ul class="circle-list clearfix">
        <!--下载地址-->
        <li class="circle-one fl" style="margin-left: 10%;"><a class="autoImg" href="${contextPath! }/doAppDownload.html?type=1"><img src="${staticPath! }/static/lansha/cf_wap/static/images/circle02.png" alt="" /></a></li>
        <li class="circle-one fr" style="margin-right: 10%;"><a class="autoImg" href="javascript:;" id="sharebtn"><img src="${staticPath! }/static/lansha/cf_wap/static/images/circle03.png" alt="" /></a></li>
    </ul>
</div>
<div class="common-border rule-box">
    <div class="autoImg"><img src="${staticPath! }/static/lansha/cf_wap/static/images/movie-title02.png" alt=""/></div>
    <p class="rule-text">
        1.活动时间：即日起至活动结束<br/>
        2.如何获得更多抽奖次数：
    </p>
    ...
    <div class="rule-text rule-child clearfix">(1)虾米礼物即时到账，可以赠送给喜欢的主播</div>
    <div class="rule-text rule-child clearfix">(2)所有中奖的钻石、首充、永久英雄级武器以Q币形式发放，在中奖后10个工作日内由工作人员发放。</div>
    <div class="rule-text rule-child clearfix">(3)实物奖励，根据用户填写的收货信息，在中奖15个工作日内发放（若信息不全或有误，则视为放弃领奖）</div>
...
<div class="download clearfix">
    <a href="${contextPath! }/doAppDownload.html?type=1&name=${name! }">
        <span class="autoImg fl"><img src="${staticPath! }/static/lansha/cf_wap/static/images/logo.png" alt=""/></span>
            ...
            <ul class="login-list fl">
                <form id="frmUserRegMini" action="register.html">
                    <li class="login-one mgt15 clearfix">
                        ...
                        <!--<a class="login-code cur fr" id="SendCode" type="button" data-apiurl="api/api.php?act=yzm">发送<br />验证码</a>-->
                    </li>
                    <li class="login-one mgt15 clearfix">
