...
<body>
    ...
    <div class="formbody">
	    <div class="rightinfo" style="overflow:auto;" id="contentDiv">
		    <form action="room-nvshen-save.html" id="form1" method="post" enctype="multipart/form-data">
			    ...
			    <div class="formtitle"><span class="sp">热门房间信息</span></div>
				    <ul class="forminfo">
					    ...
					    <li>
					    	...
					    	<input name="" type="button" class="btn" value="返回" onclick="location.href='room-nvshen.html?pageIndex=${pageIndex! }'"/>
					    </li>
				    </ul>
			    </div>
		    </form>
