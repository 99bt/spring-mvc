...
<head>
	<@lansha.meta />
    <title>蓝鲨TV手机游戏直播教程-苹果篇 - ${platFormName! }</title>
...
<div class="container">
    <div class="layout  help-box clearfix">
        <div class="help-left fl">
			<@lansha.helpLeft index="2"/>
        </div>
        <div class="help-right fr">
            <div class="help-title">如何安装及使用iphone版主播工具</div>
            ...
            <img src="${staticPath! }/static/lansha/upload/ios_new_01.png" alt="">
            <p class="help-p">备注：具体按提示流程操作即可</p>
            <p class="help-p">3. 成功通过主播审核认证</p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_2.png" alt="">
            <p class="help-p">备注：所有直播申请，3个工作日内完成审核。如有疑问，请咨询官方客服QQ：2716491563</p>
            <div class="help-num clearfix"><span class="fl">02</span><p class="fl">如何使用iphone版主播工具（支持iOS9.0以下系统）</p></div>
            <p class="help-p">1. 下载并登陆：下载地址http://lansha.tv/appdownload.html 下完成后打开蓝鲨录APP，登录主播账号</p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_3.png" alt="">
            <p class="help-p">2. 确保开启手机的AssistiveTouch、蓝鲨录的麦克风、蓝鲨录的通知</p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_4.jpg" alt="">
            <p class="help-p">3. 填写直播信息：填写直播公告、填写直播标题、选择直播的游戏、选择横竖屏直播、选择直播源清晰度</p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_5.png" alt="">
            <p class="help-p">4. 直播中：进行视频互动<br/>
                标注：①直播的游戏；②观众人数；③虾米数；④开/关隐私模式；⑤展开或缩略聊天内容；<br/>
                ⑥输入文字聊天；⑦开/关聊天内容显示；⑧开/关摄像头<br/>
            </p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_6.jpg" alt="">
            <p class="help-p">5. 开始直播游戏：返回手机主页，选择一款游戏开始直播</p>
            <img src="${staticPath! }/static/lansha/upload/ios_new_7.png" alt="">
